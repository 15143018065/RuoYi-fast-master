package com.ruoyi.project.system.ArchivesImageInfo.service;
 ...
 * @date 2021-08-24
 */
public interface IArchivesImageInfoService 
{
    /**
     * 查询档案图像存储索引信息
     * 
...
//     * @return 结果
//     */
//    public int insertArchivesImageInfo(ArchivesImageInfo archivesImageInfo, HttpServletRequest request);
